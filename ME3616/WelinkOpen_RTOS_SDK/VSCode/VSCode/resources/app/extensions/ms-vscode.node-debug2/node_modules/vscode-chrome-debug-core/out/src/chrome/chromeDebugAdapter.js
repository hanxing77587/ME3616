    ...
    onExecutionContextsCleared() {
        ...
        return this.doAfterProcessingSourceEvents(() => __awaiter(this, void 0, void 0, function* () {
            for (let scriptedParseEvent of cachedScriptParsedEvents) {
                const scriptEvent = yield this.scriptToLoadedSourceEvent('removed', scriptedParseEvent);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            this.doAfterProcessingSourceEvents(() => __awaiter(this, void 0, void 0, function* () {
                if (typeof this._columnBreakpointsEnabled === 'undefined') {
                    yield this.detectColumnBreakpointSupport(script.scriptId).then(() => __awaiter(this, void 0, void 0, function* () {
            ...
            if (targetScriptUrl) {
                ...
                return setBreakpointsPFailOnError.then(body => {
                    if (body.breakpoints.every(bp => !bp.verified)) {
                        ...
                        return this.unverifiedBpResponseForBreakpoints(originalArgs, requestSeq, body.breakpoints, localize(4, null), true);
                    }
