...
export declare namespace ProposedFeatures {
    ...
    const ConfigurationFeature: Feature<RemoteWorkspace, config.Configuration>;
    type WorkspaceFolders = folders.WorkspaceFolders;
    const WorkspaceFoldersFeature: Feature<RemoteWorkspace, folders.WorkspaceFolders>;
    const all: Features<_, _, _, _, _, ProposedFeatures.WorkspaceFolders & ProposedFeatures.Configuration>;
}
