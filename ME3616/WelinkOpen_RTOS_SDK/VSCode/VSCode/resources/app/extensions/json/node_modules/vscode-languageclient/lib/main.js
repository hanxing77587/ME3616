...
const colorProvider = require("./colorProvider.proposed");
...
(function (ProposedFeatures) {
    ...
    ProposedFeatures.ColorProviderFeature = colorProvider.ColorProviderFeature;
    function createAll(client) {
        ...
        result.push(new ProposedFeatures.ColorProviderFeature(client));
        return result;
    }
