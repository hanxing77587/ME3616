...
export declare namespace ProposedFeatures {
    ...
    type ColorProviderFeature = colorProvider.ColorProviderFeature;
    const ColorProviderFeature: typeof colorProvider.ColorProviderFeature;
    type ColorProviderMiddleware = colorProvider.ColorProviderMiddleware;
